...
public:
    ...
    void addMedicine(const string& name, double price, int quantity) {
        if (inventorySize < maxInventorySize) {
            ...
            inventorySize++;
            cout <<setw(20)<< name << " added to the inventory."<<endl;
        } else {
            ...
            case 2: {
                ...
                if (medNo >= 1 && medNo <= inventory.inventorySize) {
                    ...
                    if (inventory.inventory[index].quantity >= quantity) {
                        ...
                        cout << "Insufficient quantity of " << inventory.inventory[index].name << " in the inventory."<<endl;
                    }
                } else {
                    cout << "Invalid medicine number."<<endl;
                }
                break;
            }
            case 3:
